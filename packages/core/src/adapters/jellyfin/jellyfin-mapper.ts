...
export function mapJellyfinAuthSession(
  info: PublicSystemInfoDto,
  auth: AuthenticateResponseDto,
): AuthSession {
  return {
...
export function mapLibrary(dto: JellyfinVirtualFolderDto): Library {
  return {
    id: dto.ItemId,
    name: dto.Name,
